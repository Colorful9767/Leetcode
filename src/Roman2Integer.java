...
public class Roman2Integer {
    ...
    public static int romanToInt(String s) {
        ...
        for (int i = 0;i < s.length() - 1;i++){
            int current = ROMAN_NUMBER_MAP.get(s.charAt(i));
            int next = ROMAN_NUMBER_MAP.get(s.charAt(i+1));
        ...
        return res + ROMAN_NUMBER_MAP.get(s.charAt(s.length()-1));
    }
